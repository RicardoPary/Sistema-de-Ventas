...
$consulta=$cn->prepare('SELECT * FROM persona WHERE codigo_persona NOT IN (SELECT codigo_persona FROM proveedor) AND codigo_persona NOT IN (SELECT codigo_persona FROM persona_pasiva) AND codigo_persona NOT IN (SELECT codigo_persona FROM persona_activa)');
$consulta->execute();
?>
...
<table width="776" height="70" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
	 ...
	 <option value="Proveedor de Bienes">Proveedor de Bienes</option>
	 <option value="Proveedor de Sevicios">Proveedor de Sevicios</option>
	 <option value="Proveedor de Recursos">Proveedor de Recursos</option>
...
include('Conexion.php');
	$sql=$cn->prepare('SELECT * FROM proveedor');	
	$sql->execute();		
