...
$consulta2=$cn->prepare('SELECT * FROM producto WHERE codigo_producto NOT IN (SELECT codigo_producto FROM p_tiene)');
$consulta2->execute();
...
<fieldset>
<legend><strong>Informacion Producto Tiene</strong></legend>
...
<table width="789"  border="0" id="example">
  ...
  <tbody>
	...
	$sql=$cn->prepare('SELECT * FROM p_tiene');	
	$sql->execute();		
