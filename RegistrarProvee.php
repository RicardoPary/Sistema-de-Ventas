...
$consulta1=$cn->prepare('SELECT * FROM proveedor ');
$consulta1->execute();

$consulta2=$cn->prepare('SELECT * FROM producto WHERE codigo_producto NOT IN (SELECT codigo_producto FROM vende) AND codigo_producto NOT IN (SELECT codigo_producto FROM provee)');
$consulta2->execute();
...
<fieldset>
<legend><strong>Informacion Provee</strong></legend>
<table width="776" height="74" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
   ...
   <td>&nbsp;</td>
   <td><label for="label">Fecha:</label></td>
 ...
 <tr>
     ...
     <td width="169" height="26" scope="row"><label for="label">Codigo Producto:</label></td>
     <td width="153"><select size="1" name="select" id="CodigoProducto">
     <?php 
	...
	?>
     ...
     <td width="14">&nbsp;</td>
     <td width="96"><label for="label">Cantidad:</label></td>
     <td width="285"><input type="text" name="T2" id="Cantidad" size="30" maxlength="32" /></td>
     <td width="15">&nbsp;</td>
 </tr>
 
 <tr>
     <td width="16" scope="row">&nbsp;</td>
     <td width="169" height="26" scope="row"></td>
     <td width="153">&nbsp;</td>
     <td width="14">&nbsp;</td>
     <td width="96">&nbsp;</td>
     <td width="285">&nbsp;</td>
...
<table width="789"  border="0" id="example">
  <thead>
    <tr >
	  ...
	  <td width="128" height="25"><span class="Estilo15">Fecha</span></td>
      <td width="106"><span class="Estilo15">Cantidad</span></td>
  ...
  <tbody>
	...
	$sql=$cn->prepare('SELECT * FROM provee');	
	$sql->execute();		
