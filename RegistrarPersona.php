...
<table width="776" height="110" border="0" cellpadding="2" cellspacing="0">
          
 <tr>
     <td width="4" height="22" scope="row">&nbsp;</td>
     <td width="147" scope="row"><label for="label3">Nombre:</label></td>
     <td width="180"><input type="text" name="Nombre" id="Nombre" size="30" maxlength="128" /></td>
     <td width="13">&nbsp;</td>
 ...
 <tr>
     ...
     <td><input type="text" name="T2" id="Paterno" size="30" maxlength="32" /></td>
     <td>&nbsp;</td>
     <td><label for="label2">Nacionalidad:</label></td>
     <td><input type="text" name="T4" id="Nacionalidad" size="30" maxlength="32" /></td>
     <td>&nbsp;</td>
 </tr>
 ...
 <tr>
     ...
     <td><input type="text" name="T3" id="Materno" size="30" maxlength="32" /></td>
     <td>&nbsp;</td>
     <td><label for="label">Direccion:</label></td>
     <td><input type="text" name="T5" id="Direccion" size="30" maxlength="32" /></td>
     <td>&nbsp;</td>
 </tr>
 ...
 <tr>
     ...
     <td>
	     <select size="1" name="Genero" id="Genero">
             <option value="Masculino">Masculino</option>
             <option value="Femenino">Femenino</option>
         </select>     </td>
     <td>&nbsp;</td>
     <td><label for="label2">Telefono:</label></td>
     <td><input type="text" name="T6" id="Telefono" size="30" maxlength="32" /></td>
     <td>&nbsp;</td>	 
 </tr>
