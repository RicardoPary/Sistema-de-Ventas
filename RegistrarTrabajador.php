...
function realizaProceso(){
        var parametros = {
                "codigo_persona" : $('#CodigoPersona').val(),
               	"puesto_trabajo" : $('#PuestoTrabajo').val()
        };
        $.ajax({
                data:  parametros,
...
<fieldset>
<legend><strong>Informacion Trabajador</strong></legend>
<table width="776" height="70" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
     ...
     <td scope="row"><label for="label3">Puesto Trabajo:</label></td>
     <td>
	  <select size="1" name="Tipo" id="PuestoTrabajo">
	 ...
	 <option value="Consejo de Administracion">Consejo de Administracion</option>
	 <option value="Director Comercial">Director Comercial</option>
	 <option value="Director de Comunicacion">Director de Comunicacion</option>
	 ...
	 <option value="Director de Riesgos">Director de Riesgos</option>
	 <option value="Director de Seguridad">Director de Seguridad</option>
	 ...
	 <option value="Jefe de Marca">Jefe de Marca</option>
	 <option value="Jefe de Operaciones">Jefe de Operaciones</option>
	 <option value="Junta de Directores">Junta de Directores</option>
	 <option value="Obrero de Linea">Obrero de Linea</option>
...
<table width="788"  border="0" id="example">
  <thead>
    <tr >
      ...
      <td width="125"><span class="Estilo15">Puesto de Trabajo</span></td>
...
<tr>
  ...
  <td><span class="Estilo3"><?php echo $op['puesto_trabajo'];?></span></td>
