...
<div id="Cabeza">
<img src="Imagenes/logo10.png" width="224" height="56" style="float:left; margin-top:10px; margin-left:40px;"/>
...
<div id="Menu1">
	...
	<ul id="Menu">
           ...
           <li> <a href="">Conozcamos</a></li>
           <li> <a href="">Tiendas Comunitarias</a></li>
...
<a href="Registrar/RegistrarVisita.php?id=<?php echo $op['codigo_empresa'];?>"><img data-u="image" src="<?php echo $op['imagen'];?>" /></a>
...
<div id="CuerpoInicio" style="width:1300px;">
</div>
