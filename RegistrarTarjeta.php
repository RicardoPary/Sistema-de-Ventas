...
function realizaProceso(){
        var parametros = {
                "codigo_persona" : $('#CodigoCliente').val(),
                "nombre" : $('#Nombre').val(),
				"tipo" : $('#Tipo').val()
        };
        $.ajax({
                data:  parametros,
                url:   'CrearTarjeta.php',
                type:  'post',
...
<fieldset>
<legend><strong>Informacion Tarjeta</strong></legend>
<table width="776" height="74" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
	 ...
	 <option value="Tarjeta Monedero o Prepago">Tarjeta Monedero o Prepago</option>
	 <option value="Tarjeta Prepago Multidivisa">Tarjeta Prepago Multidivisa</option>
	 <option value="Tarjeta de Comercio">Tarjeta de Comercio</option>
...
<table width="788"  border="0" id="example">
  <thead>
    <tr >
	  <td width="128" height="25"><span class="Estilo15">Codigo Tarjeta</span></td>
      <td width="106"><span class="Estilo15">Codigo Persona Cliente</span></td>
  ...
  <tbody>
	...
	$sql=$cn->prepare('SELECT * FROM tarjeta');	
	$sql->execute();		
...
<tr>
  <td><span class="Estilo3"><?php echo $op['codigo_tarjeta'];?></span></td>
